...
public static class NotificationCategoryCodes
{
    ...
    /// <summary>Jeunes prestataires — TypeCode ex. <c>JeunesPrestataires.BesoinAide</c>, <c>JeunesPrestataires.SyntheseAValider</c>, <c>JeunesPrestataires.SyntheseValidee</c>, <c>JeunesPrestataires.CharteAcceptee</c>, <c>JeunesPrestataires.ConsentementConfirme</c>.</summary>
