...
/// <see cref="LienCoaching"/> (index unique). Au transfert de coach, la ligne existante change de
/// <see cref="LienCoachingId"/> — pas de duplication ni d'historique de versions.
/// </summary>
