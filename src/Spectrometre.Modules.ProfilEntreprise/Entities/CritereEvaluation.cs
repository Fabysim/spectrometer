...
/// <c>FirstEvaluation</c>/<c>ProfileItemPosition</c> du MVP — catégorie + libellé + niveau requis,
/// sans catalogue global. Les critères manuels et IA coexistent dans cette même table, sans flag
/// « généré par IA »).
/// </summary>
